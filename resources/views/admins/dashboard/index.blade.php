            ...
            <div class="mini-stat clearfix bx-shadow">
                ...
                <div class="tiles-progress">
                    <div class="m-t-20">
                        ...
                        <div class="progress progress-sm m-0">
                            <div class="progress-bar progress-bar-purple" role="progressbar" aria-valuenow="90"
                    ...
                    <div class="chat-conversation">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3 chat-send">
                                <button type="submit" class="btn btn-info btn-block waves-effect waves-light">Send
                                </button>
                            </div>
                        </div>
                    </div>
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body todoapp">
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <a href="" class="pull-right btn btn-primary btn-sm waves-effect waves-light"
                    ...
                    <form name="todo-form" id="todo-form" role="form" class="m-t-20">
                        <div class="row">
                            ...
                            <div class="col-sm-3 todo-send">
                                <button class="btn-primary btn-block btn waves-effect waves-light" type="button"
